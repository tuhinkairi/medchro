...
// Mock doctor data
const doctorsData = [
    { id: 1, name: 'Dr. Smith', date: '12-09-24', specialty: 'Cardiologist', location: [40.7128, -74.0060] },
    { id: 2, name: 'Dr. Johnson', date: '22-09-24', specialty: 'Dermatologist', location: [40.7145, -74.0059] },
    { id: 3, name: 'Dr. Taylor', date: '21-09-24', specialty: 'Dentist', location: [40.7138, -74.0080] },
    { id: 4, name: 'Dr. Brown', date: '2-09-24', specialty: 'Pediatrician', location: [40.7110, -74.0075] },
];
...
export default function AppointmentBooking() {
    ...
    useEffect(() => {
        if (selectedSpecialty) {
            setFilteredDoctors(doctorsData.filter(doc => doc.specialty === selectedSpecialty));
        } else {
    ...
    return (
        <div className="flex flex-col md:flex-row h-screen font-subheadingFont">
            ...
            <div className="md:w-1/3 w-full bg-white p-4 overflow-y-auto">
                <h1 className="text-xl md:text-2xl font-bold mb-4 text-center md:text-left">Find Doctors Near You</h1>
                ...
                <ul className="space-y-4">
                    {filteredDoctors.map((doctor, index) => (
                        <li key={doctor.id} className="p-4 border border-gray-300 rounded-lg shadow">
                            <h2 className="text-lg font-semibold">{doctor.name}</h2>
                            <span className='text-sm text-zinc-700'>Book on {doctor.date}</span>
